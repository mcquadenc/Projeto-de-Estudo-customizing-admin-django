...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Documento.user'
        db.alter_column('documentos_documento', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True))

    def backwards(self, orm):

        # Changing field 'Documento.user'
        db.alter_column('documentos_documento', 'user_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
